...
REFERENCE_FAMILIES = {
    ...
    "Gemma-2-2B": "Gemma",
    "Ministral-3B-Instruct-2410": "Ministral",
    "Mistral-7B": "Mistral",
    "Phi-3.5-mini": "Phi",
    "SmolLM2-135M": "SmolLM",
...
REFERENCE_MODEL_IDS = {
    ...
    "Ministral-3B-Instruct-2410": "mistralai/Ministral-3B-Instruct-2410",
...
REFERENCE_FINGERPRINTS: Dict[str, List[float]] = {
    ...
    "Ministral-3B-Instruct-2410": [0.00021, 0.0041, 1.65, 0.07, -0.18, 0.00020, 0.0039, 1.52, 0.06, -0.17, 0.00020, 0.0040, 1.58, 0.07, 3000.0, 36.0],
...
def paper_validation_checks(pairwise: pd.DataFrame, token_tax_all: pd.DataFrame) -> pd.DataFrame:
    ...
    ministral = "mistralai/Ministral-3B-Instruct-2410"
...
def build_dashboard():
    ...
    with gr.Blocks(title=APP_NAME, css=css, theme=gr.themes.Soft(primary_hue="blue", neutral_hue="slate")) as demo:
        ...
        with gr.Tab("Live Paper Experiment"):
            gr.Markdown(
                "This is the paper-accurate mode. It loads and fingerprints all four models live: Llama-3.2-1B, Ministral-3B, Qwen2.5-1.5B, and DeepSeek-R1-Distill-Qwen-1.5B. It does not use stored reference fingerprints."
            )
            gr.Markdown(
