...
The paper experiment now uses `HuggingFaceTB/SmolLM2-1.7B-Instruct` instead of Ministral so the four-model run stays lighter and more reliable on Colab-class GPUs while preserving a cross-family comparison model.
